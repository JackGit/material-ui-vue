	...
	module.exports = {
	    ...
	    data: function data() {
	        return {
	            ...
	            openPicker: false,
	            date: new Date(),
	            images: [{ url: 'http://wedding.jackyang.me/static/images/wedding_pic_01.jpg', caption: 'This is our big Tagline!', description: 'Here our small slogan.' }, { url: 'http://wedding.jackyang.me/static/images/wedding_pic_02.jpg', caption: 'Left Aligned Caption', description: 'Here our small slogan.' }, { url: 'http://wedding.jackyang.me/static/images/wedding_pic_03.jpg', caption: 'Right Aligned Caption', description: 'Here our small slogan.', captionPosition: 'left' }, { url: 'http://wedding.jackyang.me/static/images/wedding_pic_04.jpg', caption: 'This is our big Tagline!', description: 'Here our small slogan.' }]
	        };
	    },
	    ...
	    watch: {
	        ...
	        checkboxSelected: function checkboxSelected(value) {
	            console.log('checkboxSelected', value);
	        },
	        switchValue: function switchValue(value) {
	            console.log('switchValue', value);
	        },
	        rangeValue: function rangeValue(value) {
	            console.log('rangeValue', value);
	        },
	        openPicker: function openPicker(value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    'breadcrumbs': __webpack_require__(97),
	    'chip': __webpack_require__(100),
	    'link-collection': __webpack_require__(103),
	    'collection': __webpack_require__(106),
	    'collection-item': __webpack_require__(109),
	    'collection-header': __webpack_require__(112),
	    'search-bar': __webpack_require__(115),
	    'navbar': __webpack_require__(118),
	    'nav-item': __webpack_require__(121),
	    'nav-dropdown-item': __webpack_require__(125),
	    'nav-collapsible-item': __webpack_require__(128),
	    'side-nav': __webpack_require__(131),
	    'pagination': __webpack_require__(134),
	    'pagination-item': __webpack_require__(137),
	    'linear-progress': __webpack_require__(140),
	    'circle-progress': __webpack_require__(143),
	    'material-box': __webpack_require__(146),
	    'slider': __webpack_require__(149),
	    'carousel': __webpack_require__(152),
	    'modal': __webpack_require__(155),
	    'modal-content': __webpack_require__(158),
	    'modal-footer': __webpack_require__(161),
	    'footer': __webpack_require__(164),
	    'footer-copyright': __webpack_require__(167),
	    'parallax': __webpack_require__(170)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\forms\\checkbox.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\forms\\switch.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\forms\\range.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\forms\\date-picker.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./date-picker.vue", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?sourceMap!./../../../node_modules/vue-loader/lib/style-rewriter.js!./../../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./date-picker.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    components: {
	        'mui-icon': __webpack_require__(14)
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    data: function data() {
	        var iconValue = '';
	        if (this.prev) iconValue = 'chevron_left';
	
	        if (this.next) iconValue = 'chevron_right';
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] ..\\src\\components\\media\\slider.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\media\\slider.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] ..\\src\\components\\media\\carousel.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\media\\carousel.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
	...
	module.exports = {
	    ...
	    methods: {
	        next: function next(n) {
	            if (n) $(this.$el).carousel('next', [n]);else $(this.$el).carousel('next');
	        },
	        prev: function prev(n) {
	            if (n) $(this.$el).carousel('prev', [n]);else $(this.$el).carousel('prev');
	        }
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\footer\\footer.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] ..\\src\\components\\footer\\footer-copyright.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\footer\\footer-copyright.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	    __vue_script__.__esModule &&
	    Object.keys(__vue_script__).length > 1) {
	  console.warn("[vue-loader] ..\\src\\components\\parallax\\parallax.vue: named exports in *.vue files are ignored.")}
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Users\\Administrator\\Documents\\GitHub\\material-ui-vue\\src\\components\\parallax\\parallax.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div class=\"parallax-container\" :style=\"{height: height + 'px'}\">\n    <div class=\"parallax\"><img :src=\"imageUrl\"></div>\n</div>\n";
